...
Также рекомендуем вам посетить располагающуюся неподалёку Детскую железную дорогу, располагающуюся неподалёку''',
...
Также рекомендуем вам посетить располагающуюся неподалёку башню с курантами или исторический музей Оренбурга''',
           "ссылка на геокодер"),
...
Также рекомендуем вам посетить располагающийся неподалёку памтник Пушкину и Далю или исторический музей города Оренбурга''',
           'ссылка на геокодер'),
...
Также рекомендуем вам посетить мост через реку Урал''',
           'ссылка на геокодер'),
          ("Памятник Гагарину",
...
Также рекомендуем вам посетить памятник Валерию Чкалову""",
           'ссылка на геокодер'),
          ('Музей истории Оренбурга',
           '''Музей истории Оренбурга

Небольшой, но заслуживающий внимания музей расположился в старинной башне 1856 года постройки. Изначально кирпичная башня в неоготическом стиле служила кладовой казначейства, позже тут была гауптвахта.

Открытие музея состоялось в 1983 году, тогда в нем насчитывалось 6 залов, посвященных древнейшей истории, основанию города, Пугачевскому бунту, Пушкину, быту народов края и известным людям — уроженцам этих мест.

Позднее к ним добавились экспозиции, рассказывающие о конце 20-го века, архитектуре города. Появилась инсталляция дворянской комнаты. Кроме того, в музее есть научная библиотека.

Также рекомендуем вам посетить башню с курантами, располагающуюся на улице Советской''',
           'ссылка на геокодер')]
...
Выберите одну из плиток ниже'''
    ...
    if not rf:
        ...
        result = cur.execute(f"""SELECT answer FROM films WHERE name = {place}""").fetchall()
